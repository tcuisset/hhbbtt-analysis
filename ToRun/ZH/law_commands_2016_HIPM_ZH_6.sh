...
function featurePlotZbbHtt_SR {
    ...
    law run FeaturePlot --version prod_240403_nonres --PrePlot-version prod_240403 --config-name ul_2016_HIPM_ZbbHtt_v12 \
...
function featurePlotZttHbb_SR {
    ...
    law run FeaturePlot --version prod_240403_nonres --PrePlot-version prod_240403 --config-name ul_2016_HIPM_ZttHbb_v12 \
...
function makeNonResonantDatacards_ZbbHtt(){
    ...
    law run CreateDatacards --version prod_240403_nonres --FeaturePlot-version prod_240403_nonres --PrePlot-version prod_240403 --config-name ul_2016_HIPM_ZbbHtt_v12 \
...
function makeNonResonantDatacards_ZttHbb(){
    ...
    law run CreateDatacards --version prod_240403_nonres --FeaturePlot-version prod_240403_nonres --PrePlot-version prod_240403 --config-name ul_2016_HIPM_ZttHbb_v12 \
 --feature-names dnn_ZHbbtt_kl_1,ZHKinFit_mass --workers 20 --MergeCategorizationStats-version prod_240305 --MergeCategorization-version prod_240327 --Categorization-version prod_240327  \
 --dataset-names "$DATASETS_ZttHbb_nonres,$DATASETS_DATA" \
