...
function featurePlotZbbHtt {
    ...
    law run FeaturePlot --version prod_240318 --PrePlot-version prod_240318 --config-name ul_2016_ZbbHtt_v12 \
...
Htt_met_pt,Htt_met_eta,Htt_met_phi,Htt_met_mass,Zbb_pt,Zbb_eta,Zbb_phi,Zbb_mass,lep1_pt,lep1_eta,lep1_phi,lep2_pt,lep2_eta,lep2_phi,bjet1_eta,bjet1_phi,bjet1_pt,bjet2_eta,bjet2_phi,bjet2_pt \
 ...
 --workers 10 --MergeCategorizationStats-version prod_240305 --Categorization-version prod_240318 \
...
function featurePlotZttHbb {
    ...
    law run FeaturePlot --version prod_240318 --PrePlot-version prod_240318 --config-name ul_2016_ZttHbb_v12 \
...
function featurePlotZbbHtt_SR {
    ...
    law run FeaturePlot --version prod_240327 --PrePlot-version prod_240327 --config-name ul_2016_ZbbHtt_v12 \
...
function featurePlotZttHbb_SR {
    ...
    law run FeaturePlot --version prod_240327 --PrePlot-version prod_240327 --config-name ul_2016_ZttHbb_v12 \
...
law run CreateDatacards --version prod_240327 --FeaturePlot-version prod_240327 --PrePlot-version prod_240327 --config-name ul_2016_ZbbHtt_v12 \
...
# ZttHbb
law run CreateDatacards --version prod_240327 --FeaturePlot-version prod_240327 --PrePlot-version prod_240327 --config-name ul_2016_ZttHbb_v12 \
 --feature-names dnn_ZHbbtt_kl_1 --workers 20 --MergeCategorizationStats-version prod_240305 --MergeCategorization-version prod_240327 --Categorization-version prod_240327  \
