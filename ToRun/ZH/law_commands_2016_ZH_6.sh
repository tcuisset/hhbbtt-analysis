...
# 
law run CategorizationWrapper --version prod_240318 --category-names ZbbHtt_elliptical_cut_90_sr --config-name ul_2016_ZbbHtt_v12 \
 --skip-dataset-tags secondary,res \
 --PreprocessRDF-version prod_240305 \
 --PreprocessRDF-modules-file modulesrdf \
...
# 
law run CategorizationWrapper --version prod_240318 --category-names ZttHbb_elliptical_cut_90_sr --config-name ul_2016_ZttHbb_v12 \
 --skip-dataset-tags secondary,res \
 --PreprocessRDF-version prod_240305 \
 --PreprocessRDF-modules-file modulesrdf \
 --PreprocessRDF-keep-and-drop-file keep_and_drop_file \
