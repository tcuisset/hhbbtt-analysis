...
function featurePlotZbbHtt_CR {
    ...
    law run FeaturePlot --version prod_240318 --PrePlot-version prod_240318 --config-name ul_2017_ZbbHtt_v12 \
...
function featurePlotZttHbb_CR {
    ...
    law run FeaturePlot --version prod_240318 --PrePlot-version prod_240318 --config-name ul_2017_ZttHbb_v12 \
