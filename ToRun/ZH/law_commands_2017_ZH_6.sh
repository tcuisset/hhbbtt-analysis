...
law run CategorizationWrapper --version prod_240312 --category-names base,ZbbHtt_elliptical_cut_90_sr --config-name ul_2017_ZbbHtt_v12 \
 ...
 --Categorization-base-category-name base_selection --Categorization-feature-modules-file modulesrdf_Ellipse --workers 10 
...
# DNN INPUT
###############################################################################################################################################
law run CategorizationWrapper --version prod_240312_DNNinput --category-names ZbbHtt_elliptical_cut_90_sr --config-name ul_2017_ZbbHtt_v12 \
 --skip-dataset-tags secondary,res \
 --PreprocessRDF-version prod_240305 \
 ...
 --Categorization-custom-condor-tag 'include : /opt/exp_soft/cms/t3/t3queue |,T3queue=short,WNTag=el7,priority=-20' --Categorization-tasks-per-job 10


law run CategorizationWrapper --version prod_240312_DNNinput --category-names ZttHbb_elliptical_cut_90_sr --config-name ul_2017_ZttHbb_v12 \
 --skip-dataset-tags secondary,res \
 --PreprocessRDF-version prod_240305 \
 --Categorization-base-category-name base_selection \
 --Categorization-feature-modules-file modulesrdf_DNN  --Categorization-keep-and-drop-file keep_and_drop_file_DNN --workers 50 \
 --Categorization-workflow htcondor --Categorization-htcondor-scheduler llrt3condor.in2p3.fr --Categorization-transfer-logs \
 --Categorization-custom-condor-tag 'include : /opt/exp_soft/cms/t3/t3queue |,T3queue=short,WNTag=el7, priority=-22' --Categorization-tasks-per-job 10
...
law run CategorizationWrapper --version prod_240327 --config-name ul_2017_ZbbHtt_v12 \
...
law run CategorizationWrapper --version prod_240327 --config-name ul_2017_ZttHbb_v12 \
...
# 
law run FeaturePlot2D --version prod_240318 --PrePlot2D-version prod_240318 --category-name base --config-name ul_2017_ZbbHtt_v12 \
...
law run FeaturePlot2D --version prod_240318 --PrePlot2D-version prod_240318 --category-name base --config-name ul_2017_ZttHbb_v12 \
 --feature-names Ztt_svfit_mass_ellipse:Hbb_mass_ellipse --workers 10  --MergeCategorizationStats-version prod_240305 \
 --Categorization-version prod_240312 \
 --skip-dataset-tags secondary,res \
 --process-group-name zh_sig_vs_bkg --save-root --save-png --stack
...
law run FeaturePlot2D --version prod_240318 --PrePlot2D-version prod_240318 --category-name ZbbHtt_elliptical_cut_90_sr --config-name ul_2017_ZbbHtt_v12 \
 --feature-names Htt_svfit_mass_ellipse:Zbb_mass_ellipse --workers 10 --MergeCategorizationStats-version prod_240305 \
 --Categorization-version prod_240312 \
 --skip-dataset-tags secondary,res \
 --process-group-name zh_sig_vs_bkg --save-root --save-png --stack
law run FeaturePlot2D --version prod_240318 --PrePlot2D-version prod_240318 --category-name ZttHbb_elliptical_cut_90_sr --config-name ul_2017_ZttHbb_v12 \
...
function featurePlotZbbHtt_CR {
    ...
    law run FeaturePlot --version prod_240404 --PrePlot-version prod_240404 --config-name ul_2017_ZbbHtt_v12 \
...
function featurePlotZttHbb_CR {
    ...
    law run FeaturePlot --version prod_240404 --PrePlot-version prod_240404 --config-name ul_2017_ZttHbb_v12 \
...
function featurePlotZbbHtt_SR {
    ...
    law run FeaturePlot --version prod_240403_nonres --PrePlot-version prod_240403 --config-name ul_2017_ZbbHtt_v12 \
...
Htt_met_pt,Htt_met_eta,Htt_met_phi,Htt_met_mass,Zbb_pt,Zbb_eta,Zbb_phi,Zbb_mass,lep1_pt,lep1_eta,lep1_phi,lep2_pt,lep2_eta,lep2_phi,bjet1_eta,bjet1_phi,bjet1_pt,bjet2_eta,bjet2_phi,bjet2_pt \
 --dataset-names $DATASETS_ZbbHtt_nonres,$DATASETS_DATA \
 --workers 30 --MergeCategorizationStats-version prod_240305 --Categorization-version prod_240327 --MergeCategorization-version prod_240327 \
...
function featurePlotZttHbb_SR {
    ...
    law run FeaturePlot --version prod_240403_nonres --PrePlot-version prod_240403 --config-name ul_2017_ZttHbb_v12 \
...
function makeNonResonantDatacards_ZbbHtt(){
    ...
    law run CreateDatacards --version prod_240403_nonres --FeaturePlot-version prod_240403_nonres --PrePlot-version prod_240403 --config-name ul_2017_ZbbHtt_v12 \
...
function makeNonResonantDatacards_ZttHbb(){
    ...
    law run CreateDatacards --version prod_240403_nonres --FeaturePlot-version prod_240403_nonres --PrePlot-version prod_240403 --config-name ul_2017_ZttHbb_v12 \
 --feature-names dnn_ZHbbtt_kl_1,ZHKinFit_mass --workers 20 --MergeCategorizationStats-version prod_240305 --MergeCategorization-version prod_240327 --Categorization-version prod_240327  \
 --dataset-names "$DATASETS_ZttHbb_nonres,$DATASETS_DATA" \
