# same as _6.sh but with central resonant samples
source setup.sh
YEAR=2016_HIPM
...
law run PreprocessRDFWrapper --version prod_240305 --category-names base_selection --config-name ul_${YEAR}_ZttHbb_v12 \
