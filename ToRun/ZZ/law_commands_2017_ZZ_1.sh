...
# 
law run CategorizationWrapper --version prod_240207 --config-name ul_2017_ZZ_v12 \
 --skip-dataset-tags secondary --category-names ZZ_elliptical_cut_80_etau,ZZ_elliptical_cut_80_mutau,ZZ_elliptical_cut_80_tautau \
