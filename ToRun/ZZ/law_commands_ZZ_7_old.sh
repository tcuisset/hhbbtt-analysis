...
LAW__luigi_worker__force_multiprocessing=true law run CategorizationWrapper --version prod_241501 --PreprocessRDF-category-name base_selection --PreprocessRDF-version prod_241213c --PreprocessRDF-no-run --config-name bul_${YEAR}_ZbbHtt_v12 \
 ...
 --Categorization-custom-condor-tag 'include : /opt/exp_soft/cms/t3/t3queue |,priority=5,T3queue=short,WNTag=el9,request_memory=4G,+SingularityCmd = "/grid_mnt/data__data.polcms/cms/cuisset/ZHbbtautau/framework/el7_container"' \
  --Categorization-retries 0 --auto-tasks-per-job 15 --workers 50 --Categorization-no-poll 
...
law run MergeCategorizationWrapper --version prod_241213c_DNN25 --Categorization-version prod_241213c_DNN25 --PreprocessRDF-version   --config-name bul_2018_ZbbHtt_v12 --PreprocessRDF-no-run  \
 ...
 --systematic-names central,jec_1,jec_2,jec_3,jec_4,jec_5,jec_6,jec_7,jec_8,jec_9,jec_10,jec_11,jer,tes,met_unclustered,ele_scale,ele_resolution \
  --workers 5
law run MergeCategorizationWrapper --version prod_241213c_DNN25 --Categorization-version prod_241213c_DNN25  --config-name bul_2018_ZttHbb_v12 --PreprocessRDF-no-run --Categorization-no-run \
...
law run PrePlotWrapper --version prod_250117  --MergeCategorization-version prod_241213c_DNN25  --config-name bul_2018_ZZ_v12 \
  --skip-dataset-tags data \
  --category-names ZZ_EC90_boosted_bb_boostedTau,ZZ_EC90_boosted_bb_HPSTau,ZZ_EC90_resolved_2b_HPSTau,ZZ_EC90_resolved_1b_HPSTau --PrePlot-systematics  jec_1,jec_2,jec_3,jec_4,jec_5,jec_6,jec_7,jec_8,jec_9,jec_10,jec_11,jer,tes,met_unclustered,ele_scale,ele_resolution \
 ...
 --PrePlot-custom-condor-tag 'include : /opt/exp_soft/cms/t3/t3queue |,T3queue=short,WNTag=el9,request_memory=15G,+SingularityCmd = "/grid_mnt/data__data.polcms/cms/cuisset/ZHbbtautau/framework/el7_container"' --PrePlot-no-poll --workers 200
...
# ZH
law run PrePlotWrapper --version prod_250117  --MergeCategorization-version prod_241213c_DNN25  --config-name bul_2018_ZbbHtt_v12 \
  --skip-dataset-tags data \
  --category-names ZbbHtt_OC90_boosted_bb_boostedTau,ZbbHtt_OC90_boosted_bb_HPSTau,ZbbHtt_OC90_resolved_1b_HPSTau,ZbbHtt_OC90_resolved_2b_HPSTau --PrePlot-systematics  jec_1,jec_2,jec_3,jec_4,jec_5,jec_6,jec_7,jec_8,jec_9,jec_10,jec_11,jer,tes,met_unclustered,ele_scale,ele_resolution \
  --PrePlot-region-names etau_os_iso,etau_ss_iso,etau_os_inviso,etau_ss_inviso,mutau_os_iso,mutau_ss_iso,mutau_os_inviso,mutau_ss_inviso,tautau_os_iso,tautau_ss_iso,tautau_os_inviso,tautau_ss_inviso \
  --PrePlot-feature-tags base,cat,dnn --PrePlot-preplot-modules-file preplot \
  --PrePlot-workflow htcondor --PrePlot-htcondor-scheduler llrt3condor.in2p3.fr --PrePlot-transfer-logs --PrePlot-poll-interval 10 --PrePlot-submission-threads 1 --PrePlot-retries 0 \
 --PrePlot-custom-condor-tag 'include : /opt/exp_soft/cms/t3/t3queue |,priority=-1,T3queue=long,WNTag=el9,request_memory=10G,+SingularityCmd = "/grid_mnt/data__data.polcms/cms/cuisset/ZHbbtautau/framework/el7_container"' --PrePlot-no-poll --workers 200
...
ZZ_EC90_boosted_bb_HPSTau
law run FeatureHistogramWrapper --version prod_250117_datacards_v4 --PrePlot-version prod_250117  --MergeCategorizationStats-version prod_241024 --config-name bul_2018_ZZ_v12 \
...
law run FeatureHistogramWrapper --version prod_250117_datacards_v4 --PrePlot-version prod_250117  --MergeCategorizationStats-version prod_241024 --config-name bul_2018_ZZ_v12 \
 ...
 --FeatureHistogram-skip-dataset-tags nonResOnly --FeatureHistogram-feature-tags dnn --FeatureHistogram-process-group-name datacard_zz_res_reduced \
  --FeatureHistogram-hide-data True --FeatureHistogram-do-qcd  --workers 5

200,210,220,230,240,250,260,270,280,300,320,350,360,400,450,500,550,600,650,700,750,800,850,900,1000,1100,1200,1300,1400,1500,1600,1700,1800,1900,2000,2200,2400,2500,2600,2800,3000,3500,4000,4500,5000
...
law run CreateDatacardsResonantWrapper --version prod_241213c_DNN25_datacards_v3 --version-template prod_241213c_DNN25_datacards_v3_M__MASS__ --FeatureHistogram-version prod_241213c_DNN25_datacards_v3 --config-name bul_2018_ZZ_v12  \
 --resonant-masses 200,300 \
 ...
 --CreateDatacards-process-group-name datacard_zz_res_reduced  --category-names ZZ_EC90_boosted_bb_boostedTau --region-names etau_os_iso \
 --CreateDatacards-merge-bins  --CreateDatacards-hide-data True --print-status 3

# skip non-res datasets & res signal, then add back only the current mass resonant signal
MASS=3000
CATEGORY=ZZ_EC90_boosted_bb_boostedTau
REGION_NAME=etau
law run CreateDatacards --version prod_241213c_DNN25_datacards_v3_M$MASS --FeatureHistogram-version prod_241213c_DNN25_datacards_v3  --config-name bul_2018_ZZ_v12 \
 --feature-names dnn_ZZbbtt_500bv_M${MASS}  --skip-dataset-tags nonResOnly,resSignal --dataset-names-after-skip GluGluToXToZZTo2B2Tau_M${MASS} \
 --process-group-name datacard_zz_res_reduced  --category-name $CATEGORY --region-name ${REGION_NAME}_os_iso \
 --merge-bins  --hide-data True --print-status 3
