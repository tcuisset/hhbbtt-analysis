...
condor_settings = {
    "workflow" : "htcondor",
    "custom_condor_tag" : 'include : /opt/exp_soft/cms/t3/t3queue |,T3queue=short,WNTag=el9,+SingularityCmd = "/grid_mnt/data__data.polcms/cms/cuisset/ZHbbtautau/framework/el7_container"',
...
cmdline_args = [ "Categorization", 
                "--PreprocessRDF-version", "prod_241207", 
