...
# 
law run CategorizationWrapper --version prod_240207 --category-names base --config-name ul_2016_ZZ_v12 \
...
# 
law run CategorizationWrapper --version prod_240207 --category-names ZZ_elliptical_cut_80_sr --config-name ul_2016_ZZ_v12 \
 --skip-dataset-tags secondary \
 --PreprocessRDF-version prod_240128 \
...
# RUNNING
law run FeaturePlot2D --version prod_240208 --PrePlot2D-version prod_240208 --category-name base --config-name ul_2016_ZZ_v12 \
