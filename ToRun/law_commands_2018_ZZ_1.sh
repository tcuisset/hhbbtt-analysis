...
# 
law run CategorizationWrapper --version prod_240207 --category-names ZZ_elliptical_cut_80_etau --config-name ul_2018_ZZ_v12 \
...
# 
law run CategorizationWrapper --version prod_240207 --category-names ZZ_elliptical_cut_80_mutau --config-name ul_2018_ZZ_v12 \
 --skip-dataset-tags secondary \
 --PreprocessRDF-version prod_240128 \
 --Categorization-base-category-name base_selection \
 --Categorization-feature-modules-file modulesrdf_syst --workers 50 \
...
# 
law run CategorizationWrapper --version prod_240207 --category-names ZZ_elliptical_cut_80_tautau --config-name ul_2018_ZZ_v12 \
 --skip-dataset-tags secondary \
 --PreprocessRDF-version prod_240128 \
 --Categorization-base-category-name base_selection \
 --Categorization-feature-modules-file modulesrdf_syst --workers 50 \
...
# 
law run FeaturePlot2D --version prod_240208 --PrePlot2D-version prod_240208 --category-name base --config-name ul_2018_ZZ_v12 \
...
# 
law run FeaturePlot --version prod_240209 --PrePlot-skip-merging --PrePlot-version prod_240209 --config-name ul_2018_ZZ_v12 \
...
law run FeaturePlot --version prod_240208 --PrePlot-skip-merging --PrePlot-version prod_240208 --config-name ul_2018_ZZ_v12 \
...
# 
law run FeaturePlot --version prod_240225 --PrePlot-skip-merging --PrePlot-version prod_240225 --config-name ul_2018_ZZ_v12 \
