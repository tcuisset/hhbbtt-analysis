...
class BaseConfig(cmt_config):
    ...
    def add_features(self):
        ...
        features = [
            ...
            Feature("met_pt_raw", "MET_pt", binning=(20, 0, 100),
            ...
            Feature("puWeight", "puWeight", binning=(30, 0, 2),
