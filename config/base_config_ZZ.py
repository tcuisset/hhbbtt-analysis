...
class Config(cmt_config):
    ...
    def add_processes(self):
        processes = [
            Process("zh_hbb_zll_signal", Label("ZH_{bb#tau#tau}"), color=(126, 238, 124), 
                    isSigBBTT=True, ProcType="Ztautau_Hbb", isSignal=True, llr_name="ZZbbtt"),
            ...
            Process("ggXZZbbtt_M300", Label("ggX 300 GeV"), color=(208, 240, 120), 
                    isSigBBTT=True, ProcType="Zbb_Ztautau", isSignal=True, llr_name="ggXZZbbtt_M300"),
            Process("ggXZZbbtt_M400", Label("ggX 400 GeV"), color=(179, 241, 134), 
                    isSigBBTT=True, ProcType="Zbb_Ztautau", isSignal=True, llr_name="ggXZZbbtt_M400"),
            Process("ggXZZbbtt_M500", Label("ggX 500 GeV"), color=(149, 241, 147), 
                    isSigBBTT=True, ProcType="Zbb_Ztautau", isSignal=True, llr_name="ggXZZbbtt_M500"),
            Process("ggXZZbbtt_M600", Label("ggX 600 GeV"), color=(126, 238, 124), 
                    isSigBBTT=True, ProcType="Zbb_Ztautau", isSignal=True, llr_name="ggXZZbbtt_M600"),
            Process("ggXZZbbtt_M700", Label("ggX 700 GeV"), color=(118, 241, 156),
                    isSigBBTT=True, ProcType="Zbb_Ztautau", isSignal=True, llr_name="ggXZZbbtt_M700"),
            Process("ggXZZbbtt_M800", Label("ggX 800 GeV"), color=(109, 243, 187), 
                    isSigBBTT=True, ProcType="Zbb_Ztautau", isSignal=True, llr_name="ggXZZbbtt_M800"),
            Process("ggXZZbbtt_M900", Label("ggX 900 GeV"), color=(127, 232, 214), 
                    isSigBBTT=True, ProcType="Zbb_Ztautau", isSignal=True, llr_name="ggXZZbbtt_M900"),
            Process("ggXZZbbtt_M1000", Label("ggX 1.0 TeV"), color=(122, 197, 220), 
                    isSigBBTT=True, ProcType="Zbb_Ztautau", isSignal=True, llr_name="ggXZZbbtt_M1000"),
            Process("ggXZZbbtt_M1100", Label("ggX 1.1 TeV"), color=(99, 173, 199), 
                    isSigBBTT=True, ProcType="Zbb_Ztautau", isSignal=True, llr_name="ggXZZbbtt_M1100"),
            Process("ggXZZbbtt_M1200", Label("ggX 1.2 TeV"), color=(77, 149, 167), 
                    isSigBBTT=True, ProcType="Zbb_Ztautau", isSignal=True, llr_name="ggXZZbbtt_M1200"),
            Process("ggXZZbbtt_M1300", Label("ggX 1.3 TeV"), color=(54, 125, 135), 
                    isSigBBTT=True, ProcType="Zbb_Ztautau", isSignal=True, llr_name="ggXZZbbtt_M1300"),
            Process("ggXZZbbtt_M1400", Label("ggX 1.4 TeV"), color=(30, 106, 114), 
                    isSigBBTT=True, ProcType="Zbb_Ztautau", isSignal=True, llr_name="ggXZZbbtt_M1400"),
            Process("ggXZZbbtt_M1500", Label("ggX 1.5 TeV"), color=(5, 87, 92), 
                    isSigBBTT=True, ProcType="Zbb_Ztautau", isSignal=True, llr_name="ggXZZbbtt_M1500"),
            ...
            Process("zz_bbtt", Label("ZZ_{bb#tau#tau}"), color=(0, 165, 80), 
                    isSigBBTT=True, ProcType="Zbb_Ztautau",
                    parent_process="zz_background", llr_name="ZZbbtt"), # background for resonant analysis 
