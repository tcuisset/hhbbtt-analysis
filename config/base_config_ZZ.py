...
class Config(cmt_config):
    ...
    def add_features(self):
        features = [
            ...
            zz_kinfit_chi2,zz_kinfit_m,sv_m,dR_l1_l2_x_sv_pT,l1_mt,l_2_pT,dR_l1_l2,dphi_sv_met,z_bb_mass,b_2_hhbtag,diZ_mass_sv,dphi_zbb_sv,
            Z_bb_pt,dR_l1_l2_boosted_ztt_met,l_1_pT,b_1_pT,phi,costheta_l2_zttmet,b_1_cvsb,b_1_cvsl,boosted,is_vbf,jet_1_quality,jet_2_quality
            ...
            Feature("zz_kinfit_m", "hh_kinfit_m", binning=(50, 0, 1000),
                x_title=Label("ZZ m (Kin. Fit)"), units="GeV"),
            Feature("sv_m", "sv_m", binning=(70, 0, 350),
                x_title=Label("Z(#tau^{+} #tau^{-}) mass (SVFit)"), units="GeV"),
            Feature("dR_l1_l2_x_sv_pT", "dR_l1_l2_x_sv_pT", binning=(50, 0, 800), 
                x_title=Label("#DeltaR (l_{1}, l_{2}) #times p_{T} (Z_{#tau#tau}^{SVFit})")),
            Feature("l1_mt", "l_1_mt", binning=(50, 0, 200), 
                x_title=Label("m_{T} (l_{1})"), units="GeV"),
            Feature("l_2_pT", "l_2_pT", binning=(10, 50, 150),
                x_title=Label("#tau_{2} p_{t}"), units="GeV"),
            Feature("dR_l1_l2", "dR_l1_l2", binning=(50, 0, 5), 
                x_title=Label("#DeltaR (l_{1}, l_{2})")),
            Feature("dphi_sv_met", "dphi_sv_met", binning=(50, 0, 3.14), 
                x_title=Label("#Delta#phi (Z_{#tau#tau}^{SVFit}, MET)")),
            Feature("z_bb_mass", "h_bb_mass", binning=(100, 0, 500),
                x_title=Label("Z(b #bar{b}) m"), units="GeV"),
            ...
            Feature("dphi_zbb_sv", "dphi_hbb_sv", binning=(50, 0, 3.14), 
                x_title=Label("#Delta#phi (Z_{bb}, Z_{#tau#tau}^{SVFit})")),
            Feature("Z_bb_pt", "H_bb_pt", binning=(10, 50, 150),
                x_title=Label("Z(b #bar{b}) p_t"), units="GeV"),
            Feature("dR_l1_l2_boosted_ztt_met", "dnn_dR_l1_l2_boosted_htt_met", binning=(50, 0, 5), 
                x_title=Label("#DeltaR (l_{1}, l_{2}) Boost(Z_{#tau#tau}+MET)")),
            Feature("l_1_pT", "l_1_pT", binning=(10, 50, 150),
                x_title=Label("#tau_{1} p_{t}"), units="GeV"),
            Feature("b_1_pT", "b_1_pT", binning=(10, 50, 150),
                x_title=Label("b_{1} p_{t}"), units="GeV"),
            Feature("phi", "phi", binning=(50, 0, 3.14), 
                x_title=Label("#Phi")),
            Feature("costheta_l2_zttmet", "costheta_l2_httmet", binning=(50, 0, 1), 
                x_title=Label("cos#Theta")),
            Feature("b_1_cvsb", "b_1_cvsb", binning=(50, 0, 1), 
                x_title=Label("CvsB (bJet_{1})")),
            Feature("b_1_cvsl", "b_1_cvsl", binning=(50, 0, 1), 
