...
class Config(cmt_config):
    ...
    def add_processes(self):
        processes = [
            ...
            Process("ggXZZbbtt_M200", Label("ggX 200 GeV"), color=(103, 187, 171), 
                    isZZsignal=True, isSignal=True, llr_name="ggXZZbbtt_M200"),
            Process("ggXZZbbtt_M300", Label("ggX 300 GeV"), color=(103, 187, 171), 
                    isZZsignal=True, isSignal=True, llr_name="ggXZZbbtt_M300"),
            Process("ggXZZbbtt_M400", Label("ggX 400 GeV"), color=(109, 243, 187), 
                    isZZsignal=True, isSignal=True, llr_name="ggXZZbbtt_M400"),
            Process("ggXZZbbtt_M500", Label("ggX 500 GeV"), color=(144, 221, 240), 
                    isZZsignal=True, isSignal=True, llr_name="ggXZZbbtt_M500"),
            Process("ggXZZbbtt_M600", Label("ggX 600 GeV"), color=(144, 221, 240), 
                    isZZsignal=True, isSignal=True, llr_name="ggXZZbbtt_M600"),
            Process("ggXZZbbtt_M700", Label("ggX 700 GeV"), color=(54, 125, 135), 
            ...
            Process("ggXZZbbtt_M900", Label("ggX 900 GeV"), color=(54, 125, 135), 
