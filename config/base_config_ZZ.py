...
class Config(cmt_config):
    ...
    def add_processes(self):
        processes = [
            Process("zz_sl_signal", Label("ZZ #rightarrow bb#tau#tau"), color=(112, 228, 239), 
                    isZZsignal=True, isSignal=True, llr_name="ZZ_sig"),

            Process("zz_sl_background", Label("ZZ 2Q2L"), color=(3, 4, 94), 
                    isZZbackground=True, parent_process="zz"),
            Process("zz_lnu", Label("ZZ 2L2Nu"), color=(3, 4, 94), parent_process="zz_sl"),
            Process("zz_qnu", Label("ZZ 2Q2Nu"), color=(3, 4, 94), parent_process="zz_sl"),
            Process("zz_sl", Label("ZZ SL"), color=(3, 4, 94), parent_process="zz"),
            Process("zz_dl", Label("ZZ DL"), color=(48, 102, 186), parent_process="zz"),
            Process("zz_fh", Label("ZZ FH"), color=(0, 0, 0), parent_process="zz"),
            Process("zzz", Label("ZZZ"), color=(177, 190, 218), parent_process="zz"),
            ...
            Process("ggf", Label("HH_{ggF}"), color=(0, 0, 0), isSignal=False, llr_name="ggH",
                    parent_process="zz_background"),
            Process("ggf_sm", Label("HH_{ggF}"), color=(61, 59, 142), isSignal=False,
            ...
            Process("tt_sl", Label("t#bar{t} SL"), color=(48, 102, 190), parent_process="tt"),
            Process("tt_fh", Label("t#bar{t} FH"), color=(3, 4, 94), parent_process="tt"),

            Process("tth", Label("t#bar{t}H"), color=(4, 240, 106), parent_process="others",
                llr_name="ttH"),
            Process("tth_bb", Label("t#bar{t}H bb"), color=(4, 240, 106), parent_process="tth"),
            Process("tth_tautau", Label("t#bar{t}H #tau#tau"), color=(28, 124, 84), parent_process="tth"),
            Process("tth_nonbb", Label("t#bar{t}H "), color=(138, 201, 38), parent_process="tth"),

            Process("wjets", Label("W + jets"), color=(244, 44, 4), parent_process="others",
                llr_name="WJets"),
