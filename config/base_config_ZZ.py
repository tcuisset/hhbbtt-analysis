...
class Config(cmt_config):
    ...
    def add_processes(self):
        processes = [
            ...
            Process("ggXZZbbtt_M200", Label("ggX 200 GeV"), color=(126, 238, 124), 
                    isZZsignal=True, isSignal=True, llr_name="ggXZZbbtt_M200"),
            Process("ggXZZbbtt_M300", Label("ggX 300 GeV"), color=(109, 243, 187), 
                    isZZsignal=True, isSignal=True, llr_name="ggXZZbbtt_M300"),
            Process("ggXZZbbtt_M400", Label("ggX 400 GeV"), color=(127, 232, 214), 
                    isZZsignal=True, isSignal=True, llr_name="ggXZZbbtt_M400"),
            Process("ggXZZbbtt_M500", Label("ggX 500 GeV"), color=(122, 197, 220), 
                    isZZsignal=True, isSignal=True, llr_name="ggXZZbbtt_M500"),
            Process("ggXZZbbtt_M600", Label("ggX 600 GeV"), color=(99, 173, 199), 
                    isZZsignal=True, isSignal=True, llr_name="ggXZZbbtt_M600"),
            Process("ggXZZbbtt_M700", Label("ggX 700 GeV"), color=(77, 149, 167), 
                    isZZsignal=True, isSignal=True, llr_name="ggXZZbbtt_M700"),
            Process("ggXZZbbtt_M800", Label("ggX 800 GeV"), color=(54, 125, 135), 
                    isZZsignal=True, isSignal=True, llr_name="ggXZZbbtt_M800"),
            Process("ggXZZbbtt_M900", Label("ggX 900 GeV"), color=(30, 106, 114), 
                    isZZsignal=True, isSignal=True, llr_name="ggXZZbbtt_M900"),
            Process("ggXZZbbtt_M1000", Label("ggX 1.0 TeV"), color=(5, 87, 92), 
                    isZZsignal=True, isSignal=True, llr_name="ggXZZbbtt_M1000"),
            Process("ggXZZbbtt_M1100", Label("ggX 1.1 TeV"), color=(5, 87, 92), 
                    isZZsignal=True, isSignal=True, llr_name="ggXZZbbtt_M1100"),
            Process("ggXZZbbtt_M1200", Label("ggX 1.2 TeV"), color=(5, 87, 92), 
                    isZZsignal=True, isSignal=True, llr_name="ggXZZbbtt_M1200"),
            Process("ggXZZbbtt_M1300", Label("ggX 1.3 TeV"), color=(5, 87, 92), 
                    isZZsignal=True, isSignal=True, llr_name="ggXZZbbtt_M1300"),
            Process("ggXZZbbtt_M1400", Label("ggX 1.4 TeV"), color=(5, 87, 92), 
            ...
            Process("ggXZZbbtt_M2000", Label("ggX 2.0 TeV"), color=(5, 87, 92), 
                    isZZsignal=True, isSignal=True, llr_name="ggXZZbbtt_M2000"),
            Process("ggXZZbbtt_M3000", Label("ggX 3.0 TeV"), color=(5, 87, 92), 
    ...
    def add_features(self):
        features = [
            ...
            Feature("ZZKinFit_mass", "ZZKinFit_mass", binning=(50, 0, 1000),
                ...
                systematics=["tes", "jer", "jec_1", "jec_2", "jec_3", "jec_4", "jec_5", "jec_6", 
                             "jec_7", "jec_8", "jec_9", "jec_10", "jec_11"]),
            Feature("ZZKinFit_mass_fine", "ZZKinFit_mass", binning=(600, 0, 3000),
                x_title=Label("ZZ mass (Kin. Fit)"),
                units="GeV",
                systematics=["tes", "jer", "jec_1", "jec_2", "jec_3", "jec_4", "jec_5", "jec_6", 
                             "jec_7", "jec_8", "jec_9", "jec_10", "jec_11"]),
