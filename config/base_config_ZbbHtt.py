...
class ConfigZbbHtt(BaseConfig):
    def __init__(self, *args, **kwargs):
        ...
        #     ),
        #     resonant=DotDict(
        #         model_folder="/grid_mnt/data__data.polcms/cms/cuisset/ZHbbtautau/frameworkJobs/nanoaod_base_analysis/data/cmssw/CMSSW_12_3_0_pre6/src/cms_runII_dnn_models/models/arc_checks/zz_bbtt/2025_01_09/ResZbbHtt-0/",
    ...
    def get_dnn_config(self, category, isResonant:bool):
        ...
        if isResonant:
            ...
            if "boosted_bb" in category.get_aux("jet_category"):
                return DotDict(
                    model_folder="/grid_mnt/data__data.polcms/cms/cuisset/ZHbbtautau/framework9/nanoaod_base_analysis/data/cmssw/CMSSW_15_0_3/src/cms_runII_dnn_models/models/arc_checks/zz_bbtt/2025_04_17/ZbbHtt_Boosted-0", 
                    out_branch="dnn_ZHbbtt_kl_1",
                    # systematics=["tes", "jer", "jec"]
                )
            elif "resolved_" in category.get_aux("jet_category"):
                return DotDict(
                    model_folder="/grid_mnt/data__data.polcms/cms/cuisset/ZHbbtautau/framework9/nanoaod_base_analysis/data/cmssw/CMSSW_15_0_3/src/cms_runII_dnn_models/models/arc_checks/zz_bbtt/2025_04_17/ZbbHtt_Resolved-0", 
                    out_branch="dnn_ZHbbtt_kl_1",
                    # systematics=["tes", "jer", "jec"]
                )
    ...
    def add_categories(self, **kwargs):
        ...
        for orthogonality_name, orthogonality_cut in [("EC", "true"), ("OC", orthogonality)]:
            ...
            categories.append(
            Category(f"ZbbHtt_{orthogonality_name}90_sr", f"ZbbHtt {orthogonality_name} mass cut E=90% && Signal region", # for DNN training
                    selection=jrs([
                        elliptical_cut_90,
                        orthogonality_cut,
                        jrs([
