...
def get_common_datasets_v12(self):
    ...
    p_DNN_dataCMS = "/data_CMS/cms/cuisset/ZHbbtautau/DNNTrainingSamples/2016_HIPM/" # these samples are not on GRIF EOS but on data_CMS (there was a problem with GRIF at the time) 
    ...
    datasets = [
        ...
        # MET 
        # MET_Run2016B1 is empty after goldenjson ? in any case no events pass our selections
        # Dataset("data_met_a1",
