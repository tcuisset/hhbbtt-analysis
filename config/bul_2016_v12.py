...
def get_common_datasets_v12(self):
    ...
    p_DNN_dataCMS = "/data_CMS/cms/cuisset/ZHbbtautau/DNNTrainingSamples/2016/" # these samples are not on GRIF EOS but on data_CMS (there was a problem with GRIF at the time) 
