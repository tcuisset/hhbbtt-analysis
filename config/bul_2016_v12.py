...
#    self.btag=DotDict(tight=0.7264, medium=0.2770, loose=0.0494)
    ...
    self.particleNetMD_legacy=DotDict(high=0.9883, medium=0.9735, low=0.9137)
...
def get_common_datasets_v12(self):
    ...
    p_data = "/eos/grif/cms/llr/store/user/tcuisset/boostedTaus/2016_data/"
    hleprare = "/eos/cms/store/group/phys_higgs/HLepRare/HTT_skim_v1/Run2_2016/"
    ...
    datasets = [
        ...
        Dataset("data_etau_a",
            ...
            tags=["ul", "nanoV10", "bul", "data", "hpsData", "dataNoBoostedTaus"]),
        Dataset("data_etau_b",
            folder=hleprare + "SingleElectron_Run2016G",
            selection="pairType == 1",
            process=self.processes.get("data_etau"),
            runEra="G",
            categorization_merging={'boosted_bb': 1, 'resolved_1b_HPSTau': 1, 'resolved_2b_HPSTau': 1, 'base': 2},
            prefix="eoscms.cern.ch//",
            tags=["ul", "nanoV10", "bul", "data", "hpsData", "dataNoBoostedTaus"]),
        Dataset("data_etau_c",
            folder=hleprare + "SingleElectron_Run2016H",
            selection="pairType == 1",
            process=self.processes.get("data_etau"),
            runEra="H",
            categorization_merging={'boosted_bb': 1, 'resolved_1b_HPSTau': 1, 'resolved_2b_HPSTau': 1, 'base': 2},
        ...
        Dataset("data_mutau_b",
            folder=hleprare + "SingleMuon_Run2016G",
            process=self.processes.get("data_mutau"),
            selection="pairType == 0",
            runEra="G",
            categorization_merging={'boosted_bb': 1, 'resolved_1b_HPSTau': 1, 'resolved_2b_HPSTau': 1, 'base': 2},
        ...
        Dataset("data_mutau_c",
            folder=hleprare + "SingleMuon_Run2016H",
            process=self.processes.get("data_mutau"),
            selection="pairType == 0",
            runEra="H",
            categorization_merging={'boosted_bb': 1, 'resolved_1b_HPSTau': 1, 'resolved_2b_HPSTau': 1, 'base': 2},
