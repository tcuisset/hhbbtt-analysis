...
from config.bul_2017_v12 import setupBtagDeeptau, get_common_datasets_v12

class Config_bul_2017_ZZ_v12(base_config_ZZ):
        ...
        datasets += ObjectCollection([
            ...
            *(
            ...
            Dataset("zz_bbtt_dnnTraining", # ZZ->bbtautau private sample for DNN training
                folder="/grid_mnt/data__data.polcms/cms/cuisset/ZHbbtautau/DNNTrainingSamples/2017/ZZbbtt_v1_inclusive/",
            ...
            Dataset("zz_bbtt_vptFilter_dnnTraining", # ZZ->bbtautau private sample for DNN training
                folder="/grid_mnt/data__data.polcms/cms/cuisset/ZHbbtautau/DNNTrainingSamples/2017/ZZbbtt_v1_VptGt200/",
                process=self.processes.get("zz_sl_signal_dnnTraining"),# genfilter_denominator_weights=True which is not needed. Normally no need to apply genfilter but should not do anything. Would need a new process to disable
...
config = Config_bul_2017_ZZ_v12("bul_2017_ZZ_v12", year=2017, ecm=13, lumi_pb=41529, isUL=True, AnalysisType="Zbb_Ztautau")
