...
def get_common_datasets_v12(self):
    ...
    p_data = "/eos/grif/cms/llr/store/user/tcuisset/boostedTaus/2018_data/"
    ...
    datasets = [
        ...
        Dataset("ggZH_HToBB_ZToLL",
            ...
            xs=1.,#self.cross_section_dict["ggZH_HToBB_ZToLL"],
            categorization_merging={'':1},
            # categorization_batching={"resolved_1b_HPSTau" : 22},
            prefix="eos.grif.fr//",
            tags=["ul", "nanoV10", "bul"]),
        ...
        ######################################## Data #################################################
        ###############################################################################################
        # TODO these need to be renanoed for Jet HEM issue
        # Tau 2018
        Dataset("data_tau_a",
            folder=hleprare + "Tau_Run2018A",
        ...
        # EGamma 2018
        Dataset("data_etau_a",
            folder=hleprare + "EGamma_Run2018A",
            ...
            tags=["ul", "nanoV10", "bul", "data", "hpsData"]),
        Dataset("data_etau_b",
            folder=hleprare + "EGamma_Run2018B",
            selection="pairType == 1",
            process=self.processes.get("data_etau"),
            runEra="B",
            categorization_merging={'': 1},
            ...
            tags=["ul", "nanoV10", "bul", "data", "hpsData"]),
        Dataset("data_etau_c",
            folder=hleprare + "EGamma_Run2018C",
            selection="pairType == 1",
            process=self.processes.get("data_etau"),
            runEra="C",
            categorization_merging={'': 1},
            ...
            tags=["ul", "nanoV10", "bul", "data", "hpsData"]),
        Dataset("data_etau_d",
            folder=hleprare + "EGamma_Run2018D",
            selection="pairType == 1",
            process=self.processes.get("data_etau"),
            runEra="D",
            categorization_merging={'boosted_bb_boostedTau': 1, 'boosted_bb_HPSTau': 1, 'resolved_1b_HPSTau': 2, 'resolved_2b_HPSTau': 1, 'base': 3},
        ...
        Dataset("data_mutau_a",
            folder=hleprare + "SingleMuon_Run2018A",
        ...
        Dataset("data_mutau_b",
            folder=hleprare + "SingleMuon_Run2018B",
            process=self.processes.get("data_mutau"),
            selection="pairType == 0",
            runEra="B",
            categorization_merging={'': 1},
        ...
        Dataset("data_mutau_c",
            folder=hleprare + "SingleMuon_Run2018C",
            process=self.processes.get("data_mutau"),
            selection="pairType == 0",
            runEra="C",
            categorization_merging={'': 1},
        ...
        Dataset("data_mutau_d",
            folder=hleprare + "SingleMuon_Run2018D",
            process=self.processes.get("data_mutau"),
            selection="pairType == 0",
            runEra="D",
            categorization_merging={'boosted_bb_boostedTau': 1, 'boosted_bb_HPSTau': 1, 'resolved_1b_HPSTau': 2, 'resolved_2b_HPSTau': 1, 'base': 3},
