...
def get_common_datasets_v12(self):
    ...
    datasets = [
        ...
        Dataset("data_tau_a",
            ...
            selection="!isBoostedTau && pairType == 2",
            process=self.processes.get("data_tau"),
            runEra="A",
            splitting=-1,
            # categorization_max_events=10000,
            prefix="eoscms.cern.ch//",
            tags=["ul", "nanoV10", "bul", "data"]),
        Dataset("data_tau_b",
        ...
        Dataset("data_etau_a",
            ...
            selection="!isBoostedTau && pairType == 1",
        ...
        Dataset("data_mutau_a",
            ...
            selection="!isBoostedTau && pairType == 0",
