...
from config.ul_2016_HIPM_ZZ import Config_ul_2016_HIPM_ZZ as Config_ul_2016_HIPM_ZZ_v9

class Config_ul_2016_HIPM_v10(Config_ul_2016_HIPM_ZZ_v9):
    def __init__(self, *args, **kwargs):
        super(Config_ul_2016_HIPM_v10, self).__init__(*args, **kwargs)
        self.btag=DotDict(tight=0.6502, medium=0.2598, loose=0.0508)
    ...
    def add_datasets(self):
        ...
        v9_datasets = super(Config_ul_2016_HIPM_v10, self).add_datasets()
        datasets = [
...
config = Config_ul_2016_HIPM_v10("ul_2016_HIPM_v10", year=2016, ecm=13, lumi_pb=19500, isUL=True, ispreVFP=True)
