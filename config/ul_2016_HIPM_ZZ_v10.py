...
class Config_ul_2016_HIPM_ZZ_v10(base_config_ZZ):
...
config = Config_ul_2016_HIPM_ZZ_v10("ul_2016_HIPM_ZZ_v10", year=2016, ecm=13, lumi_pb=19500, isUL=True, ispreVFP=True, AnalysisType="Zbb_Ztautau")
