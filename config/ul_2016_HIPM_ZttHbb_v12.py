...
class Config_ul_2016_HIPM_ZH_v12(ConfigZttHbb):
...
config = Config_ul_2016_HIPM_ZH_v12("ul_2016_HIPM_ZttHbb_v12", year=2016, ecm=13, lumi_pb=19500, isUL=True, ispreVFP=True, runPeriod="preVFP", AnalysisType="Ztautau_Hbb")
