...
from config.ul_2016_ZZ import Config_ul_2016_ZZ as Config_ul_2016_ZZ_v9

class Config_ul_2016_v10(Config_ul_2016_ZZ_v9):
    def __init__(self, *args, **kwargs):
        super(Config_ul_2016_v10, self).__init__(*args, **kwargs)
    ...
    def add_datasets(self):
        ...
        v9_datasets = super(Config_ul_2016_v10, self).add_datasets()
        datasets = [
...
config = Config_ul_2016_v10("ul_2016_v10", year=2016, ecm=13, lumi_pb=36310, isUL=True, ispreVFP=False) # [FIXME]
