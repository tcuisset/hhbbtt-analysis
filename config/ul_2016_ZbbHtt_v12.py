...
class Config_ul_2016_ZH_v12(ConfigZbbHtt):
...
config = Config_ul_2016_ZH_v12("ul_2016_ZbbHtt_v12", year=2016, ecm=13, lumi_pb=16800, isUL=True, AnalysisType="Zbb_Htautau", ispreVFP=False, runPeriod="postVFP")
