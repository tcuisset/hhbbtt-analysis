...
def get_common_datasets_v10(self):
    ...
    datasets = [
        ...
        Dataset("dy",
            ...
            # selection=" && ".join([f"event != {event}" for event in 
            #     [167782476, 77941414, 53094929,  41233321,  113224332, 93076324,  210274535, 56062021,  212511720, 107486895, 
            #      19808125,  11211102, 211434471, 179784488, 105653342, 188444107, 249873564, 165863932, 131751738, 70605034, 
            #      29057504,  36313795, 9692158,   225205247, 108670563, 159055446, 14593398,  78951910,  169381970] ]),
            xs=6077.22,
            merging={
                "tautau": 10,
                "etau": 10,
