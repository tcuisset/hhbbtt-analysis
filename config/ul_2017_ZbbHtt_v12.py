...
from config.ul_2017_v9 import get_2017_weights, get_common_datasets_v9
from config.ul_2017_v10 import setupBtagDeeptau, get_common_datasets_v10

class Config_ul_2017_ZH_v10(base_config_ZH):
...
config = Config_ul_2017_ZH_v10("ul_2017_ZbbHtt_v10", year=2017, ecm=13, lumi_pb=41529, isUL=True, AnalysisType="Zbb_Htautau")
