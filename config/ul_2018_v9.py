...
def get_common_datasets_v9(self):
    datasets = [
        ...
        Dataset("wjets_MLM",
            ...
            # prefix="xrootd-cms.infn.it//",
            xs=61526.7, # NNLO : 3 * https://twiki.cern.ch/twiki/bin/viewauth/CMS/StandardModelCrossSectionsat13TeV#:~:text=l%CE%BD%2C%20l%3D%CE%BC-,20508.9,-%2B165.7%20%2D88.2%20(%C2%B1%20770.9
